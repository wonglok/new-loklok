<template>
  <div>
    ...
    <input placeholder="Keywords to Scan" @keyup.enter="analyseFiles" type="text" v-model="term" class="px-5 py-2 text-xl bg-gray-200 text-gray-600 border-gray-600 rounded-lg mx-2" />
